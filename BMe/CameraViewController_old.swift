 ...
 */
protocol CameraViewControllerDelegate_old
{
...
class CameraViewController_old: UIViewController {
    ...
    // MARK: - Delegate
    var delegate: CameraViewControllerDelegate_old?
    ...
    @IBAction func onUpload(_ sender: UIButton) {
        ...
        // Save to camera roll
        UIImageWriteToSavedPhotosAlbum(resultImage, self, #selector(CameraViewController_old.image(_:didFinishSavingWithError:contextInfo:)), nil)
...
// MARK: Mode selection
extension CameraViewController_old {
    // MARK: Mode Change
...
extension CameraViewController_old: UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: CameraViewController_old.collectionViewCellReuseIdentifier , for: indexPath) as? BubbleCollectionViewCell else {
...
// MARK: Text Field
extension CameraViewController_old: UITextFieldDelegate {
